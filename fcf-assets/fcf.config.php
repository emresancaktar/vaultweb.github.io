...
// EMAIL MESSAGE
// *************
define('EMAIL_TO', 'emre@vault63.com');
...
define('EMAIL_FROM', 'dev@vault63.com');
...
define('SMTP_USER', 'dev@vault63.com');
define('SMTP_PASS', 'Alfaromeo159tbiti');
define('SMTP_AUTH', '');
define('SMTP_SECURE', '587'); // STARTTLS, SMTPS (port 465) or empty
define('SMTP_PORT', '');
